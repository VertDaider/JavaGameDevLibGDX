...
import ru.serioussem.tanks.*;
import ru.serioussem.tanks.units.BotEmitter;
import ru.serioussem.tanks.units.BotTank;
...
import ru.serioussem.tanks.utils.KeysControl;
...
public class GameScreen extends AbstractScreen {
    ...
    public void show() {
        ...
        soundPickUp = Gdx.audio.newSound(Gdx.files.internal("assets/powerup5.wav"));
        soundGameOver = Gdx.audio.newSound(Gdx.files.internal("assets/gameOver.wav"));
        soundHitInPlayer = Gdx.audio.newSound(Gdx.files.internal("assets/hitInPlayer.wav"));
