...
public class GameScore {
    ...
    public static boolean isNewRecord(GameType gameType, int score) throws IOException {
        switch (gameType) {
            case NORMAL:
                filePath = ".." + fileSeparator + "assets" + fileSeparator + "highScore";
                break;
            case NIGHTMARE:
                filePath = ".." + fileSeparator + "assets" + fileSeparator + "highScoreNightmare";
                break;
            case TIME:
                filePath = ".." + fileSeparator + "assets" + fileSeparator + "highScoreTime";
        }
        if (isFileExist()) {
            fillFile();
        }
