...
public abstract class BaseGame extends Game {
    ...
    public void create() {
        ...
        FreeTypeFontGenerator fontGenerator = new FreeTypeFontGenerator(Gdx.files.internal("core/assets/fonts/OpenSans.ttf"));
        ...
        Texture buttonTex = new Texture(Gdx.files.internal("core/assets/image/button.png"));
