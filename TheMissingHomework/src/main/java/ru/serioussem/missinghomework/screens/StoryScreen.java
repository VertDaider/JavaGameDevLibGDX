...
public class StoryScreen extends BaseScreen {
    ...
    public void initialize() {
        ...
        dialogBox.setDialogSize(800, 150);
    ...
    public void hallway() {
        ...
        scene.addSegment(new SceneSegment(background, Actions.run(this::classroom)));
        scene.start();
    }
    ...
    public void classroom() {
        ...
        scienceLabButton.addListener((Event e) -> {
                    ...
                    scene.addSegment(new SceneSegment(background, Actions.fadeOut(1)));
                    scene.addSegment(new SceneSegment(background, Actions.run(this::scienceLab)));
                    return false;
                }
        );
        ...
        libraryButton.addListener((Event e) -> {
            ...
            scene.addSegment(new SceneSegment(kelsoe, SceneActions.moveToOutsideLeft(1)));
            scene.addSegment(new SceneSegment(background, Actions.fadeOut(1)));
            scene.addSegment(new SceneSegment(background, Actions.run(this::library)));
            return false;
        });
